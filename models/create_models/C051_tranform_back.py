...
from C000_path_variables_create import host, user, passwd, db_name_compact
...
db_name_back = 'modeltransformback'
...
create_database(host, user, passwd, db_name_back)

# get database connections
call_graph_com = get_database_connection(host, user, passwd, db_name_compact)
call_graph_back = get_database_connection(host, user, passwd, db_name_back)
